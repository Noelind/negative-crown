<article class="flex flex-col lg:flex-row md:items-center lg:items my-10 lg:gap-28">
    <a href="article" class="lg:shrink-0">
        <picture class="">
            ...
            <img class="mb-5 eyelid-fx ease-in-out duration-1500 grayscale hover:grayscale-0"
    ...
    <div class="flex flex-col justify-between">
        <a href="article">
            <h2 class="mb-5 lg:mb-8 text-3xl lg:text-5xl font-medium leading-11 md:leading-13">Organising my bookshelf for the millionth time</h2>
        </a>
